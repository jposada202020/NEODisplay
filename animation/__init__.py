...
Adapted to work with the LEDSimulation class from the Adafruit_CircuitPython_LED_Animation library.
...
from functions import MS_PER_SECOND, monotonic_ms
...
class Animation:
    ...
    def __init__(
        self, pixel_object, speed, color, peers=None, paused=False, name=None
    ):
